...
Stack<Integer> stackOfLines = new Stack<Integer>(); // Stack para guardar los nÃºmeros de lÃ­nea (para anidamiento de for/if)
private int numLineaDecl; // Guarda el nÃºmero de lÃ­neal del comienzo de declaraciÃ³n
private int countSize; // Cuenta cantidad de elementos inicializados en el arreglo
private String elems; // Guarda los elementos iniciales de la colecciÃ³n
private String tipovar; // Almacena el tipo de la variable/colecciÃ³n para su seteo posterior en TS
private SyntacticTreeCtrl nodoRaiz; // Raiz del Ã¡rbol sintÃ¡ctico
...
break;
case 20:
//#line 136 "gramatica (12).y"
{ elems= val_peek(0).sval; countSize++;}
break;
case 21:
//#line 137 "gramatica (12).y"
{ elems= val_peek(0).sval; countSize++;}
break;
case 22:
...
>>>>>>> f75def1... comentario
{ semanticStructStack.addMsg("Linea "+ stackOfLines.peek().intValue() +": Bloque de ejecuciÃ³n"); }
>>>>>>> 3ddb440... Update Parser / ElementoTS :+1:
=======
...
>>>>>>> cf97fd0... Arreglos en ventana
{ 
                semanticStructStack.addMsg("Linea "+ stackOfLines.peek().intValue() + ": Asignaciï¿½n"); 
                stackOfLines.pop();
...
>>>>>>> f75def1... comentario
{ 
                semanticStructStack.addMsg("Linea "+ stackOfLines.peek().intValue() + ": AsignaciÃ³n"); 
                stackOfLines.pop();
            }
=======
...
{ 
						...
						if(!symbolTable.get(val_peek(3).sval).isDeclarada() || !symbolTable.get(val_peek(1).sval).isDeclarada())
							...
							if (symbolTable.get(val_peek(1).sval).getEstructuraID().equals(ElementoTS.VAR)) {
								...
								msgStack.addMsg("ERROR: El subÃ­ndice es distinto a una variable o constante.");
						}
					}
>>>>>>> cf97fd0... Arreglos en ventana
break;
...
{ msgStack.addMsg("Error: Constante a la izquierda de una asignaciÃ³n"); }
break;
case 79:
<<<<<<< HEAD
<<<<<<< HEAD
...
>>>>>>> f75def1... comentario
{ msgStack.addMsg("Error: Sentencia invÃ¡lida"); }
>>>>>>> 3ddb440... Update Parser / ElementoTS :+1:
break;
case 80:
