...
public class Lexicon {
	...
	private void initStateMachine () {
		...
		this.stateMachine[0][14]=new Pair();
		...
		this.stateMachine[1][14]=new Pair();
		...
		this.stateMachine[2][14]=new Pair();
		...
		this.stateMachine[3][14]=new Pair();
		this.stateMachine[4][0]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][1]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][2]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][3]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][4]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][5]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][6]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][7]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][8]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][9]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][10]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][11]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][12]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][13]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[4][14]=new Pair();
		this.stateMachine[5][0]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][1]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][2]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][3]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][4]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][5]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][6]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][7]= new Pair(3,new SemanticActionAddCharacter());
		...
		this.stateMachine[5][10]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][11]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][12]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][13]= new Pair(3,new SemanticActionAddCharacter());
		this.stateMachine[5][14]=new Pair();
		this.stateMachine[6][0]= new Pair();
		this.stateMachine[6][1]= new Pair();
		this.stateMachine[6][2]= new Pair();
		this.stateMachine[6][3]= new Pair();
		this.stateMachine[6][4]= new Pair();
		this.stateMachine[6][5]= new Pair();
		this.stateMachine[6][6]= new Pair();
		this.stateMachine[6][7]= new Pair();
		this.stateMachine[6][8]= new Pair();
		this.stateMachine[6][9]= new Pair();
		this.stateMachine[6][10]= new Pair();
		this.stateMachine[6][11]= new Pair();
		this.stateMachine[6][12]= new Pair();
		this.stateMachine[6][13]= new Pair();
		this.stateMachine[6][14]=new Pair();
		this.stateMachine[7][0]= new Pair();
		this.stateMachine[7][1]= new Pair();
		this.stateMachine[7][2]= new Pair();
		this.stateMachine[7][3]= new Pair();
		this.stateMachine[7][4]= new Pair();
		this.stateMachine[7][5]= new Pair();
		this.stateMachine[7][6]= new Pair();
		this.stateMachine[7][7]= new Pair();
		this.stateMachine[7][8]= new Pair();
		this.stateMachine[7][9]= new Pair();
		this.stateMachine[7][10]= new Pair();
		this.stateMachine[7][11]= new Pair();
		this.stateMachine[7][12]= new Pair();
		this.stateMachine[7][13]= new Pair();
		this.stateMachine[7][14]=new Pair();
		this.stateMachine[8][0]= new Pair();
		this.stateMachine[8][1]= new Pair();
		this.stateMachine[8][2]= new Pair();
		this.stateMachine[8][3]= new Pair();
		this.stateMachine[8][4]= new Pair();
		this.stateMachine[8][5]= new Pair();
		this.stateMachine[8][6]= new Pair();
		this.stateMachine[8][7]= new Pair();
		this.stateMachine[8][8]= new Pair();
		this.stateMachine[8][9]= new Pair();
		this.stateMachine[8][10]= new Pair();
		this.stateMachine[8][11]= new Pair();
		this.stateMachine[8][12]= new Pair();
		this.stateMachine[8][13]= new Pair();
		this.stateMachine[8][14]=new Pair();
	}
